...
export DB_PORT=3306
export DB_USER=enki	# make sure this is consistent with /ansible/group_vars/{ENV}.yaml
export DB_PASSWORD=Chelsea77RocknRolla # make sure this is consistent with /ansible/group_vars/{ENV}.yaml
export DB_NAME=enki # make sure this is consistent with /ansible/group_vars/{ENV}.yaml
